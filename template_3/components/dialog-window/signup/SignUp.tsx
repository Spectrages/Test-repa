...
import FirstSignUpStep from './first-step/FirstStep';
import { ISignUpTemplate } from './types';
import SecondSignUpStep from './next-step/SecondStep';
...
const SignUp: React.FC<ISignUpProps> = ({ onClose }) => {
  ...
  const components = [
    ...
    <SecondSignUpStep handleClick={handleClick} handleGetData={handleGetData} key={currentStep}/>
  ];
