  ...
  return (
    <div id="filter" className={styles.filter}>
      <div className={styles.container}>
        <Text className={styles.filter__title} weight="bold" transform="uppercase" color="white">
          {t("filter", { ns: "common" })}
        </Text>
        <Text className={styles.filter__subtitle} size="sm" color='white'>
          {t("filter_subtitle", { ns: "common" })}
        </Text>
        ...
        <Address setAddressValue={setAddressValue} handleSearch={handleSearch} isDisabledButton={isDisabledButton} />
      </div>
    </div>
  );
};
